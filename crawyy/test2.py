...
lst_url = ['RJYY01', 'RJYY02', 'RJYY03', 'RJYY04', 'RJYY05', 'RJYY06', 'RJYY07', 'RJYY08']
...
if __name__ == '__main__':
    ...
    for i in list(range(len(lst_dir))):
        ...
        for i in list(range(120)):
            if i < 10:
                audio_url = url + '000' + repr(i) + '.mp3'
                img_url = url + '000' + repr(i) + '.jpg'
                audio_path = _path + os.sep + '000' + repr(i) + '.mp3'
                img_path = _path + os.sep + '000' + repr(i) + '.jpg'
            else:
